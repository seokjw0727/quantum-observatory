...
checks={
    ...
    '/research/':'sorting-papers-without-ranking-quality',
    '/topics/error-correction/':'A comparison worksheet',
    '/analysis/surface-code-memory-and-the-computation-gap/':'Paper in focus',
    '/analysis/neutral-atom-logical-count-and-accepted-shots/':'Paper in focus',
    '/analysis/trapped-ion-logical-errors-and-physical-baselines/':'Paper in focus',
    '/guides/sorting-papers-without-ranking-quality/':'Unknown is different from zero',
